const VeryHighMoraleSVGProject = ({ ...props }: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" {...props}>
      <circle cx="256" cy="256" r="256" fill="#008000" />
      <path d="M256,0v512c141.385,0,256-114.615,256-256S397.385,0,256,0z" fill="#006600" />
...
export default VeryHighMoraleSVGProject;
